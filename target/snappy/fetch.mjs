...
{
  const module = new WebAssembly.Module(await (await (await import('node-fetch').then(x => x.default))('https://unpkg.com/@evan/wasm@0.0.9/src/snappy/snappy.wasm')).arrayBuffer());
