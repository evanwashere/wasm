(module
  ...
  (func $f21 (type $t0) (param $p0 i32) (param $p1 i32)
    ...
    i32.store offset=32
    unreachable)
  (func $f22 (type $t12) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i64)
