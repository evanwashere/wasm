(module
  ...
  (func $f38 (type $t0) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    ...
    i32.load offset=12
    call_indirect (type $t0) $T0)
  (func $f39 (type $t7) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32)
  ...
  (func $f55 (type $t9) (param $p0 i32) (result i64)
    i64.const 805193655951424642)
  (func $f56 (type $t5) (param $p0 i32) (result i32)
    i32.const 0)
  (func $f57 (type $t2) (param $p0 i32) (param $p1 i32)
    ...
    i32.const 1072819
    i32.store)
  (func $f58 (type $t2) (param $p0 i32) (param $p1 i32)
    local.get $p0
    i32.const 0
    i32.store)
  (func $f59 (type $t1) (param $p0 i32) (param $p1 i32) (result i32)
    ...
    global.set $g0
    local.get $l3)
  (func $f60 (type $t4) (param $p0 i32) (param $p1 i32) (param $p2 i32)
  ...
  (global $__data_end i32 (i32.const 1073680))
  (global $__heap_base i32 (i32.const 1073680))
