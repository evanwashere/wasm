(module
  ...
  (func $f1 (type $t1) (param $p0 i32) (result i32)
  ...
  (func $f6 (type $t9) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32)
  ...
  (func $f8 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
  ...
  (func $compressor_flush (type $t0) (param $p0 i32)
    ...
    unreachable)
  (func $f20 (type $t12) (param $p0 i32) (param $p1 i32)
    (local $l2 i32)
    global.get $g0
    i32.const 48
    i32.sub
    ...
    i32.store offset=32
    unreachable)
  (func $f21 (type $t3) (param $p0 i32) (param $p1 i32)
    (local $l2 i32)
    global.get $g0
    i32.const 48
    i32.sub
    ...
    i32.store offset=32
    unreachable)
  (func $f22 (type $t12) (param $p0 i32) (param $p1 i32)
    (local $l2 i32)
    global.get $g0
    i32.const 48
    i32.sub
    ...
    i32.store offset=32
    unreachable)
  (func $f23 (type $t7) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i64)
  ...
  (func $f33 (type $t3) (param $p0 i32) (param $p1 i32)
    ...
    i32.const 0
    i32.store)
  (func $f34 (type $t2) (param $p0 i32) (result i64)
    i64.const -4948843637147525472)
  (func $f35 (type $t1) (param $p0 i32) (result i32)
    i32.const 0)
  (func $f36 (type $t2) (param $p0 i32) (result i64)
    i64.const 8175836112050307322)
  (func $f37 (type $t2) (param $p0 i32) (result i64)
    i64.const -1333387601321332916)
  (func $f38 (type $t4) (param $p0 i32) (param $p1 i32) (result i32)
    unreachable)
  (func $f39 (type $t6) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    unreachable)
  (func $wfree (type $t3) (param $p0 i32) (param $p1 i32)
    nop)
  (func $f41 (type $t0) (param $p0 i32)
    nop)
  (table $T0 38 38 funcref)
  (memory $memory 17)
  (global $g0 (mut i32) (i32.const 1048576))
  (global $cur_len i32 (i32.const 1073312))
  (global $__data_end i32 (i32.const 1073792))
  (global $__heap_base i32 (i32.const 1073792))
